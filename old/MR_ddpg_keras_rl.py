...
actor.add(Dense(64, kernel_initializer=last_init))
actor.add(Activation('relu'))
actor.add(Dense(32, kernel_initializer=last_init))
actor.add(Activation('relu'))
...
x = Dense(64, kernel_initializer=last_init)(x)
x = Activation('relu')(x)
x = Dense(32, kernel_initializer=last_init)(x)
x = Activation('relu')(x)
